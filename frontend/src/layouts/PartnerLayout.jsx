...
import { FaHotel, FaUserCircle, FaSignOutAlt, FaBuilding } from 'react-icons/fa';
...
const PartnerLayout = () => {
    ...
    const navItems = [
        { path: '/partner', icon: <FaUserCircle />, label: 'Profile' },
        { path: '/partner/inventory', icon: <FaHotel />, label: 'Inventory' },
    ];
